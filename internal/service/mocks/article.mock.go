...
func (m *MockArticleService) GetByIds(ctx context.Context, ids []int64) (domain.Interactive, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleServiceMockRecorder) GetByIds(ctx, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByIds", reflect.TypeOf((*MockArticleService)(nil).GetByIds), ctx, ids)
}
...
func (m *MockArticleService) ListPub(ctx context.Context, offset, limit int) domain.Article {
	m.ctrl.T.Helper()
