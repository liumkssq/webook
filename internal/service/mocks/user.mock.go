...
// Source: D:\webook\internal\service\user.go
//
// Generated by this command:
//
//	mockgen -source=D:\webook\internal\service\user.go -package=svcmocks -destination=D:\webook\internal\service\mocks\user.mock.go
//
